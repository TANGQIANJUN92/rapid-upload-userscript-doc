...
- 支持批量提取(换行分隔符), 支持 url 传参(一键秒传), 格式：`https://pan.baidu.com/#bdlink=[70720912ec76709070f9306ff8970308#0bddf8fba6a5ebf276c44ac426a6d1a4#40863526#把话说进孩子心里,刘杰编著,北京：中国纺织出版社.zip]`，[参数]为 base64 加密过的任意格式链接 (支持批量)
